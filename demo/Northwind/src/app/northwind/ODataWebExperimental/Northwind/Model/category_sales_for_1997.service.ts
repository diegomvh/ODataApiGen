...
@Injectable()
export class Category_Sales_for_1997Service extends ODataModelService {
  static modelType = 'NorthwindModel.Category_Sales_for_1997';
  static collectionType = 'NorthwindModel.Category_Sales_for_1997Collection';
