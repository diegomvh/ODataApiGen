...
@Injectable()
export class SuppliersService extends ODataModelService<Supplier> {
  static model = 'NorthwindModel.Supplier';
  static collection = 'NorthwindModel.SupplierCollection';
