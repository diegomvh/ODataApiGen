...
@Injectable()
export class Sales_Totals_by_AmountsService extends ODataModelService {
  static modelType = 'NorthwindModel.Sales_Totals_by_Amount';
  static collectionType = 'NorthwindModel.Sales_Totals_by_AmountCollection';
