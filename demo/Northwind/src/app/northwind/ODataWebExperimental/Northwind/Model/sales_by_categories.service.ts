...
@Injectable()
export class Sales_by_CategoriesService extends ODataModelService {
  static modelType = 'NorthwindModel.Sales_by_Category';
  static collectionType = 'NorthwindModel.Sales_by_CategoryCollection';
