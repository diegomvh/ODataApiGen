...
@Injectable()
export class Summary_of_Sales_by_YearsService extends ODataModelService {
  static modelType = 'NorthwindModel.Summary_of_Sales_by_Year';
  static collectionType = 'NorthwindModel.Summary_of_Sales_by_YearCollection';
