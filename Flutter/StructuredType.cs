...
{
    public abstract class StructuredType : FlutterRenderable, DotLiquid.ILiquidizable
  {
    ...
    public Flutter.StructuredType Base { get; private set; }
    ...
    protected IEnumerable<string> RenderNavigationPropertyBindings(IEnumerable<Models.NavigationPropertyBinding> bindings)
    {
      ...
      foreach (var binding in bindings)
      {
        ...
        var entity = (Program.Package as Flutter.Package).FindEntity(navEntity.NamespaceQualifiedName);
    ...
    return this.cast<{entity.ImportedName}>('{propertyEntity.NamespaceQualifiedName}') as {entity.Name}Model<{entity.ImportedName}>;
        ...
        else
        {
          ...
          var castEntity = (Program.Package as Flutter.Package).FindEntity(propertyEntity.NamespaceQualifiedName);
